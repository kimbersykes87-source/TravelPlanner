...
| Sheet                    | Supabase Table               | Key Columns (from [ARCHITECTURE.md](../architecture/ARCHITECTURE.md))                                    |
| ------------------------ | ---------------------------- | ---------------------------------------------------------------------------------------- |
...
You referenced [Travel Planner - Digital Nomad.xlsx](c:\Users\kimbe\Downloads\Travel Planner - Digital Nomad.xlsx). The schema above is based on the documented sheets in [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) and [APPLICATION_SUMMARY.md](../specs/APPLICATION_SUMMARY.md). When implementing:
...
- **Design system** (colors, typography) from [DESIGN_SYSTEM.md](../specs/DESIGN_SYSTEM.md).
